object LearningScala3 {
  ...
  def bigdata(s:String):String={
  	s.toUpperCase()
  }                                               //> bigdata: (s: String)String
  bigdata("foo")                                  //> res3: String = FOO
  def upper(s:String, f:String=>String):String={
  	f(s)
  }                                               //> upper: (s: String, f: String => String)String
  upper("u.s.a",x=>x.toUpperCase())               //> res4: String = U.S.A
}